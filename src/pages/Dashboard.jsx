...
export default function Dashboard({ selectedMonth, onPreviousMonth, onNextMonth }) {
  ...
  const renderCurrentView = () => {
    ...
    switch (view.name) {
      ...
      case 'bancos': return <BancosTab onBack={handleBackToMain} onCardClick={(banco) => handleNavigate('cardDetail', banco)} selectedMonth={selectedMonth} />;
      case 'categorias': return <CategoriasPage onBack={handleBackToMain} onNavigate={handleNavigate} />;
