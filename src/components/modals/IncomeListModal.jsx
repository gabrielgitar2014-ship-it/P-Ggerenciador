...
export default function IncomeListModal({ onClose, incomes, onEdit, onSave, onRefresh, onAddNew }) {
  ...
  return (
    <DialogContent className="sm:max-w-lg p-0">
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-xl w-full max-w-lg overflow-y-auto max-h-[90vh]">
